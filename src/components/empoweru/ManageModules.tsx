 ...
 * ManageModules
 *
 * Module management component for EmpowerU admin.
 * Allows creating, editing, and managing training modules and quizzes.
 */
...
export function ManageModules({ baseRoute = '/admin/empoweru' }: ManageModulesProps) {
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-white/50 text-sm">Manage training modules across all portals</p>
        </div>
        <Link
          href={`${baseRoute}/modules/new`}
                  ...
                  >
                    ...
                    <td className="py-4 px-4">
                      <div className="flex items-center justify-end gap-1">
                        ...
                        <Link
                          href={`${baseRoute}/modules/${module.id}/edit`}
                        ...
                        <Link
                          href={`${baseRoute}/modules/${module.id}/quiz`}
